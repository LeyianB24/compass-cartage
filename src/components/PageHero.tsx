...
export default function PageHero({
  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-hairline bg-navy-deep dark:bg-[#030d14] text-paper">
      ...
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-[1] bg-gradient-to-r from-[#092634]/95 via-[#092634]/85 to-[#092634]/60 dark:from-[#030d14]/95 dark:via-[#030d14]/85 dark:to-[#030d14]/65"
      />
      <div
        aria-hidden="true"
      ...
      >
        <path
          ...
          strokeLinecap="round"
        />
        <circle cx="600" cy="25" r="3" fill="#ff6e42" />
      </svg>
